CC=gcc
CFLAGS=-Wall -DUNIX_HOST -static -fno-pic -fno-builtin -fno-strict-aliasing -Wall -ggdb -m32 -fno-omit-frame-pointer -fno-stack-protector 
#CFLAGS=-fno-pic -static -fno-builtin -fno-strict-aliasing -Wall -MD -ggdb -m32 -Werror -fno-omit-frame-pointer 
#CLFAGS=-DUNIX_HOST -Wall -g -pedantic 
...
SRCS	= picoc.c table.c lex.c parse.c expression.c heap.c type.c \
	...
	cstdlib/stdio.c cstdlib/string.c\
#	cstdlib/math.c cstdlib/string.c cstdlib/stdlib.c \
...
clean:
	rm -f $(TARGET) $(OBJS) *~ *.d ./cstdlib/*.d ./platform/*.d
