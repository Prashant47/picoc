...
void StdioSetupFunc(void)
{
    ...
    StructFileType = TypeCreateOpaqueStruct(NULL, TableStrRegister("__FILEStruct"),148);
    ...
    TypeCreateOpaqueStruct(NULL, TableStrRegister("__va_listStruct"),148);
